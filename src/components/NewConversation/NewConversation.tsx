...
export default function NewConversation() {
    ...
    return (
        <ContentLayout
            header={
                <Header
                    description="Upload your audio file to be processed by Insight Care HealthScribe"
        ...
        >
            <Container
                header={
                    <Header
                        variant="h3"
                        description="Note: We offers additional features not built into this application, such as Custom Vocabulary, Content Removal, and more."
                    />
                }
            >
